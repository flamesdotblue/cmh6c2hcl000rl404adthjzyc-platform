...
export default function EdHero() {
  return (
    <section className="relative w-full h-[78vh] sm:h-[86vh] overflow-hidden" id="home">
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#0a0b0f]/40 via-[#0a0b0f]/55 to-[#0a0b0f]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(0,229,255,0.12),_transparent_60%)]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-full px-4 sm:px-6 flex items-center">
        <div className="w-full">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/30 px-3 py-1 mb-4 backdrop-blur">
            ...
            <span className="text-xs text-white/70">Real-time Campus Intelligence</span>
          </div>

          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold leading-tight tracking-tight">
            Unite your campus with ERP + AI
          </h1>
          <p className="mt-3 sm:mt-4 max-w-2xl text-sm sm:text-lg text-white/70">
            A hyper-clean, cloud-native platform for student information, finance, timetabling, attendance, and learning analytics—optimized by AI for speed and clarity.
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-4 text-xs text-white/60">
              <span className="inline-flex items-center gap-1"><BarChart2 className="h-3.5 w-3.5 text-[#00E5FF]"/> Live analytics</span>
              <span className="inline-flex items-center gap-1"><Shield className="h-3.5 w-3.5 text-[#39FF14]"/> FERPA-ready</span>
              <span className="inline-flex items-center gap-1"><span className="text-[#00E5FF]">99.99%</span> uptime</span>
            </div>
          </div>
        </div>
      </div>
