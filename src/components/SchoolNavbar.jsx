    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-[#0a0b0f]/70 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm sm:text-base font-semibold tracking-tight text-white">EduNexus ERP+AI</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <a href="#demo" className="inline-flex items-center justify-center rounded-md text-sm font-semibold px-4 py-2 bg-[#00E5FF] text-black hover:brightness-110 transition shadow-[0_0_30px_rgba(0,229,255,0.35)]">Request Demo</a>
