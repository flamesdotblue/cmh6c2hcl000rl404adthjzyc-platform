...
import { Activity, Cloud, Shield, Workflow } from 'lucide-react';
...
const features = [
  {
    ...
    accent: '#00E5FF',
    desc: 'Streaming metrics, anomaly detection, and predictive KPIs across every workflow.'
  },
  {
    icon: Cloud,
    title: 'Cloud Reliability',
    accent: '#39FF14',
    desc: 'Auto-scaling, multi-region HA, and zero-downtime releases with continuous validation.'
  },
  {
    icon: Workflow,
    title: 'End-to-End Efficiency',
    accent: '#00E5FF',
    desc: 'Unified data model that accelerates order-to-cash, procure-to-pay, and plan-to-produce.'
  },
  {
    icon: Shield,
    title: 'Security & Governance',
    accent: '#39FF14',
    desc: 'Granular RBAC, audit trails, encryption in transit and at rest, and policy automation.'
  }
];
    ...
    <section id="features" className="relative py-14 sm:py-20 bg-[#0a0b0f]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <div className="mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-4xl font-bold">Unified processes. Instant clarity.</h2>
          <p className="mt-2 text-white/60 max-w-2xl">Dynamic, segmented displays communicate the flow of data across your business—clearly and continuously.</p>
        </div>
